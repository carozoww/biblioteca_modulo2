    ...
    document.querySelectorAll('.tab-content').forEach(tab => {
        ...
        if (buscador) {
            buscador.addEventListener('input', () => {
                ...
                filas.forEach(f => {
                    if (f.classList.contains('sin-prestamos')) return; // ignora este mensaje
                ...
                // mostrar/ocultar el mensaje "No hay préstamos..." según haya resultados
                const filaMensaje = tbody.querySelector('.sin-prestamos');
